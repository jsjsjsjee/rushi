...
try:
    ...
    print("NLTK data download failed, but continuing anyway")

class SimpleNewsAnalyzer:
    def __init__(self):
        # Keywords that might indicate unreliable news
        ...
        # Keywords that might indicate more reliable news
        self.credible_words = {
    ...
    def analyze_text(self, text):
        ...
        # Count suspicious and credible indicators
...
# Replace the fake news detector with our simple analyzer
